...
function App() {
          ...
          <form onSubmit={handleLoginSubmit} className="space-y-6">
            <div>
              ...
              <input 
                ...
                className="w-full bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl border border-white/10 rounded-md p-4 text-white focus:outline-none focus:border-blue-500 transition-colors"
              />
            </div>
            <div>
            ...
            <button 
              ...
              className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-400 hover:to-emerald-500 disabled:from-gray-600 disabled:to-gray-700 disabled:text-slate-400 text-white py-4 rounded-md font-bold transition-all shadow-sm shadow-blue-500/30 text-lg">
  ...
  return (
    <div className="min-h-screen text-white font-sans flex flex-col md:flex-row p-0 md:p-4 md:gap-4" style={{ backgroundImage: "url('/bg-abstract.jpg')", backgroundSize: 'cover', backgroundAttachment: 'fixed', backgroundPosition: 'center' }}>
      ...
      <div className="w-64 bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl border border-white/10 shadow-sm rounded-lg p-6 flex flex-col justify-between">
            ...
            {visibleTabs.map(tabKey => (
              <button 
                ...
                className={`w-full text-left px-4 py-3 rounded-md transition-all ${
                  activeTab === tabKey 
                    ? tabKey === 'dashboard' ? 'bg-gradient-to-r from-cyan-400 to-purple-500 text-white font-bold shadow-sm shadow-blue-500/40' 
                      : 'bg-gradient-to-r from-blue-100 to-blue-50 text-blue-400 font-bold' 
                    : 'hover:bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl text-slate-400'
                }`}>
                {tabNames[tabKey]}
              </button>
            ))}
        ...
        <div>
          <button 
            ...
            className="w-full mt-8 bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl hover:bg-red-500/20 hover:text-red-400 text-slate-400 py-3 rounded-md font-bold transition-colors border border-white/10 hover:border-red-500/50">
            🚪 Đăng xuất
          </button>
      ...
      <div className="flex-1 bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl border border-white/10 shadow-sm rounded-lg p-8 overflow-y-auto relative">
          ...
          <div className="animate-in fade-in duration-500 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl rounded-lg p-6 border border-blue-500/30 relative overflow-hidden group">
                ...
                <h3 className="text-slate-400 font-bold mb-2 flex items-center gap-2"><span>📈</span> Tổng Doanh Thu</h3>
              ...
              <div className="bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl rounded-lg p-6 border border-orange-500/30 relative overflow-hidden group">
                ...
                <h3 className="text-slate-400 font-bold mb-2 flex items-center gap-2"><span>👥</span> Chi phí Nhân sự</h3>
                <div className="text-3xl font-bold text-orange-400">1,200,000 đ</div>
                <p className="text-sm text-slate-400 mt-2">Dựa trên 34 giờ làm việc</p>
              </div>
                ...
                <div className="h-64 flex items-end gap-4 mt-8">
                  {[
                    ...
                    <div key={idx} className="flex-1 flex flex-col items-center gap-2 group">
                      ...
                      <span className="text-slate-400 text-sm font-mono">{bar.time}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl rounded-lg p-6 border border-white/10">
                ...
                <div className="space-y-4">
                  <div className="bg-slate-50/80 rounded-md p-4 border border-white/10">
                    ...
                    <div className="flex justify-between text-sm"><span className="text-slate-400">25,000đ/h</span><span className="text-orange-600 font-bold">200,000 đ</span></div>
                  </div>
                  <div className="bg-slate-50/80 rounded-md p-4 border border-white/10">
                    ...
                    <div className="flex justify-between text-sm"><span className="text-slate-400">22,000đ/h</span><span className="text-orange-600 font-bold">132,000 đ</span></div>
                  </div>
                </div>
              </div>
          ...
          <div className="animate-in fade-in duration-500 h-full flex flex-col relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 flex-1 min-h-0">
              ...
              <div className="col-span-2 bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl rounded-2xl p-6 border border-white/10 shadow-sm flex flex-col h-full min-h-0">
                ...
                <p className="text-sm text-slate-400 mb-6">Thêm, sửa, xóa các mặt hàng sẽ xuất hiện trên màn hình thu ngân.</p>
                
                {/* Sub-tab Navigation */}
                <div className="flex gap-2 mb-6 border-b border-white/10 pb-4">
                  <button onClick={() => setRecipeTab('products')} className={`px-4 py-2 rounded-lg font-bold transition-colors ${recipeTab === 'products' ? 'bg-blue-600/70 backdrop-blur-md border border-blue-400/30 shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_25px_rgba(37,99,235,0.5)] text-white' : 'bg-white/10 hover:bg-white/20 text-slate-300 hover:bg-white/20'}`}>Sản Phẩm</button>
                  <button onClick={() => setRecipeTab('categories')} className={`px-4 py-2 rounded-lg font-bold transition-colors ${recipeTab === 'categories' ? 'bg-blue-600/70 backdrop-blur-md border border-blue-400/30 shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_25px_rgba(37,99,235,0.5)] text-white' : 'bg-white/10 hover:bg-white/20 text-slate-300 hover:bg-white/20'}`}>Danh Mục</button>
                  <button onClick={() => setRecipeTab('ingredients')} className={`px-4 py-2 rounded-lg font-bold transition-colors ${recipeTab === 'ingredients' ? 'bg-blue-600/70 backdrop-blur-md border border-blue-400/30 shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_25px_rgba(37,99,235,0.5)] text-white' : 'bg-white/10 hover:bg-white/20 text-slate-300 hover:bg-white/20'}`}>Nguyên Liệu</button>
                </div>

                {recipeTab === 'products' && (
                  <>
                    <div className="flex justify-between items-center mb-6">
                      <p className="text-sm text-slate-400">Quản lý và cập nhật danh sách các mặt hàng xuất hiện trên POS.</p>
                      <button onClick={() => {
                        setEditingProduct(null);
                        setProductForm({ name: '', price: '', image: null, icon: '📦', category: '', status: 'not_ready', recipe: [] });
                        setShowProductModal(true);
                      }} className="bg-blue-600/70 backdrop-blur-md border border-blue-400/30 shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_25px_rgba(37,99,235,0.5)] hover:bg-blue-700/70 backdrop-blur-md text-white px-5 py-2.5 rounded-lg font-bold transition-colors shadow-sm flex items-center gap-2">
                        + Thêm Sản Phẩm Mới
                      </button>
                    </div>
                ...
                {recipeTab === 'categories' && (
                  <div className="flex-1 flex flex-col min-h-0 animate-in fade-in duration-300">
                    <div className="flex gap-2 mb-4">
                      <input type="text" placeholder="Tên danh mục mới..." value={newCategory.name} onChange={e => setNewCategory({...newCategory, name: e.target.value})} className="flex-1 bg-white/5 border border-white/10 rounded-lg p-2 text-white" />
                      <button onClick={() => {
                        if(newCategory.name) {
                          setCategories([...categories, { id: 'cat' + Date.now(), name: newCategory.name }]);
                          setNewCategory({ id: '', name: '' });
                        }
                      }} className="bg-blue-600/70 backdrop-blur-md border border-blue-400/30 shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_25px_rgba(37,99,235,0.5)] hover:bg-blue-700/70 backdrop-blur-md text-white px-4 rounded-lg font-bold">Thêm</button>
                    </div>
                  ...
                  <div className="flex-1 flex flex-col min-h-0 animate-in fade-in duration-300">
                    <div className="flex gap-2 mb-4 bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl p-3 rounded-lg border border-white/10 flex-wrap items-end">
                      <div className="flex-1 min-w-[150px]">
                        <label className="text-xs font-bold text-slate-400 mb-1 block">Tên NL</label>
                      ...
                      <div className="w-24">
                        <label className="text-xs font-bold text-slate-400 mb-1 block">Đơn vị</label>
                      ...
                      <div className="w-28">
                        <label className="text-xs font-bold text-slate-400 mb-1 block">Giá vốn</label>
                      ...
                      }} className="bg-blue-600/70 backdrop-blur-md border border-blue-400/30 shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_25px_rgba(37,99,235,0.5)] hover:bg-blue-700/70 backdrop-blur-md text-white px-4 h-[38px] rounded-lg font-bold">Thêm</button>
                    </div>
                    <div className="flex-1 overflow-y-auto bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl rounded-2xl p-6 border-2 border-white/10 shadow-inner space-y-2">
                      {ingredients.map(ing => (
                        <div key={ing.id} className="flex justify-between items-center bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl p-4 rounded-xl border border-white/10 shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.08)] transition-all duration-300">
                          <div>
                            ...
                            <div className="text-xs text-slate-400">{ing.cost} đ / {ing.unit}</div>
                          </div>
              ...
              <div className="col-span-1 bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl rounded-2xl p-6 border border-white/10 shadow-sm flex flex-col h-full min-h-0">
                ...
                <p className="text-sm text-slate-400 mb-6">Thiết lập các ghi chú thường dùng để thu ngân chọn nhanh khi order.</p>

                <div className="flex flex-col gap-2 mb-6">
                  <input type="text" placeholder="Nhập ghi chú mới..." value={newNote} onChange={e => setNewNote(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && handleAddNewNote()} className="w-full bg-white/5 border border-white/10 rounded-lg p-3 text-white text-sm" />
                  <button onClick={handleAddNewNote} className="w-full bg-blue-600/70 backdrop-blur-md border border-blue-400/30 shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_25px_rgba(37,99,235,0.5)] hover:bg-blue-700/70 backdrop-blur-md text-white p-3 rounded-lg font-bold transition-colors">Thêm</button>
                </div>
                ...
                <div className="flex-1 overflow-y-auto bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl rounded-2xl p-6 border-2 border-white/10 shadow-inner flex flex-col gap-2">
                  {predefinedNotes.map((note, idx) => (
                    <div key={idx} className="flex justify-between items-center bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl p-4 rounded-xl border border-white/10 shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.08)] transition-all duration-300">
                      ...
                      <button onClick={() => { setConfirmDialog({ isOpen: true, message: 'Bạn có chắc chắn muốn xóa ghi chú này?', onConfirm: () => deletePredefinedNote(note) }); }} className="text-slate-400 hover:text-red-400 transition-colors">✕</button>
                    </div>
                  ))}
              ...
              <div className="col-span-1 bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl rounded-2xl p-6 border border-white/10 shadow-sm flex flex-col h-full min-h-0">
                ...
                <p className="text-sm text-slate-400 mb-6">Thiết lập các biến thể kích thước (S, M, L, XL...) và giá cộng thêm.</p>

                <div className="flex flex-col gap-2 mb-6">
                  <input type="text" placeholder="Tên (VD: Size L)" value={newSizeName} onChange={e => setNewSizeName(e.target.value)} className="w-full bg-white/5 border border-white/10 rounded-lg p-3 text-white text-sm" />
                  <input type="number" placeholder="+Giá (VNĐ)" value={newSizePrice} onChange={e => setNewSizePrice(e.target.value)} className="w-full bg-white/5 border border-white/10 rounded-lg p-3 text-white text-sm" />
                  <button onClick={handleAddNewSize} className="w-full bg-blue-600/70 backdrop-blur-md border border-blue-400/30 shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_25px_rgba(37,99,235,0.5)] hover:bg-blue-700/70 backdrop-blur-md text-white p-3 rounded-lg font-bold transition-colors">Thêm</button>
                </div>
                ...
                <div className="flex-1 overflow-y-auto bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl rounded-2xl p-6 border-2 border-white/10 shadow-inner flex flex-col gap-2">
                  {predefinedSizes.map((sz, idx) => (
                    <div key={idx} className="flex justify-between items-center bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl p-4 rounded-xl border border-white/10 shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.08)] transition-all duration-300">
                      ...
                      <button onClick={() => { setConfirmDialog({ isOpen: true, message: 'Bạn có chắc chắn muốn xóa kích cỡ này?', onConfirm: () => deletePredefinedSize(idx) }); }} className="text-slate-400 hover:text-red-400 transition-colors">✕</button>
                    </div>
                  ))}
        ...
        activeTab === 'settings' ? (
          <div className="animate-in fade-in duration-500 space-y-6">
            <div>
              ...
              <p className="text-slate-400">Tùy biến SmartStore cho phù hợp với mô hình kinh doanh của bạn.</p>
              {isSettingsDirty && (
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <div className="bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl rounded-lg p-6 border border-white/10 flex flex-col">
                ...
                <p className="text-sm text-slate-400 mb-6">Đổi tên các chức năng theo đúng ngôn ngữ của quán (ví dụ: Quản lý Sản phẩm -&gt; Quần áo).</p>
              ...
              <div className="bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl rounded-lg p-6 border border-white/10">
                ...
                <p className="text-sm text-slate-400 mb-6">Chọn mô hình bán hàng và tùy biến tên gọi các khu vực (Ví dụ: Đổi "Bàn" thành "Phòng thử đồ" hoặc "Ghế").</p>
                ...
                <div className="grid grid-cols-3 gap-4 mb-6">
                  ...
                  <div 
                    ...
                    <p className="text-xs text-slate-400 mt-1">Dành cho Cafe, Quán ăn (Có sơ đồ Bàn)</p>
                  </div>
                  {/* Layout 2 */}
                  <div 
                    ...
                    <p className="text-xs text-slate-400 mt-1">Dành cho Shop quần áo, Take-away (Vào thẳng chọn món)</p>
                  </div>
                  {/* Layout 3 */}
                  <div 
                    ...
                    <p className="text-xs text-slate-400 mt-1">Dành cho Spa, Bida, Phòng thử đồ</p>
                  </div>
                </div>
                ...
                {editPosConfig.layout !== 'retail' && (
                  <div className="grid grid-cols-3 gap-4 border-t border-white/10 pt-6">
                    <div>
                      ...
                      <input type="text" value={editPosConfig.title} onChange={e => handlePosConfigEdit({title: e.target.value})} className="w-full bg-white/5 border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:border-blue-500" />
                    </div>
                    <div>
                      <label className="block text-slate-400 text-sm mb-1 uppercase">Tên gọi từng ô (VD: Bàn, Ghế)</label>
                      <input type="text" value={editPosConfig.entityName} onChange={e => handlePosConfigEdit({entityName: e.target.value})} className="w-full bg-white/5 border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:border-blue-500" />
                    </div>
                    <div>
                      <label className="block text-slate-400 text-sm mb-1 uppercase">Icon Emoji cho từng ô</label>
                      <input type="text" value={editPosConfig.entityIcon} onChange={e => handlePosConfigEdit({entityIcon: e.target.value})} className="w-full bg-white/5 border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:border-blue-500" />
                    </div>
                  </div>
                )}
              </div>
            ...
            <button onClick={saveSettings} className={`w-full font-bold py-4 rounded-md transition-colors shadow-sm text-lg ${isSettingsDirty ? 'bg-orange-500 hover:bg-orange-600 text-white shadow-orange-500/30' : 'bg-blue-600/70 backdrop-blur-md border border-blue-400/30 shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_25px_rgba(37,99,235,0.5)] hover:bg-blue-700/70 backdrop-blur-md text-white shadow-blue-500/30'}`}>
          ...
          (posConfig.layout !== 'retail' && !selectedTable) ? (
            ...
            <div className="flex flex-col-reverse md:flex-row gap-2 h-full animate-in slide-in-from-right-8 duration-300 min-h-0 bg-white/10 hover:bg-white/20 p-2 rounded-sm border border-white/10 relative overflow-y-auto md:overflow-hidden">
              ...
              <div className="w-full md:w-[450px] flex flex-col bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl border border-white/10 shrink-0 shadow-sm rounded-sm h-[60vh] md:h-auto min-h-[400px]">
                {/* Header */}
                <div className="bg-blue-700/70 backdrop-blur-md text-white p-2 flex justify-between items-center shrink-0 gap-2">
                  {posConfig.layout !== 'retail' && (
                    <button onClick={() => switchTable(null)} className="text-white border border-white/10/30 hover:bg-blue-800/70 backdrop-blur-md px-3 py-1.5 rounded-md text-sm font-bold whitespace-nowrap transition-colors flex items-center gap-1 shadow-sm">
                  ...
                  {cart.length > 0 && (
                    <button 
                      ...
                      className="text-xs bg-yellow-500 hover:bg-yellow-400 text-white px-2 py-1 font-bold transition-colors shadow-sm">
                      [F3] Lưu tạm
                    </button>
                  )}
                </div>
                ...
                <div className="flex-1 overflow-y-auto bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl border-b border-white/10">
                  <table className="w-full text-left text-xs border-collapse">
                    <thead className="bg-white/20 sticky top-0 border-b border-white/10 z-10 shadow-sm">
                      <tr>
                        <th className="p-1 border-r border-white/10 w-8 text-center text-slate-300">Xóa</th>
                        <th className="p-1 border-r border-white/10 text-white">Tên hàng</th>
                        <th className="p-1 border-r border-white/10 w-10 text-center text-white">SL</th>
                        <th className="p-1 border-r border-white/10 w-20 text-right text-white">Đơn giá</th>
                        <th className="p-1 w-24 text-right text-white">Thành tiền</th>
                      </tr>
                    </thead>
                    <tbody>
                      {cart.length === 0 ? (
                        ...
                        cart.map((c, i) => (
                          <tr key={i} onClick={() => setSelectedCartItemDetail(c)} className="border-b border-white/10 hover:bg-blue-500/10 cursor-pointer text-white">
                            ...
                            <td className="p-1 border-r border-white/10 font-medium truncate max-w-[120px]">
                              {c.name}
                              {c.note && <div className="text-[10px] text-slate-400 italic block truncate">{c.note}</div>}
                            </td>
                            ...
                            <td className="p-1 text-right font-mono font-bold text-white">{(c.price * c.qty).toLocaleString()}</td>
                          </tr>
                        ))
                      )}
                    </tbody>
                  ...
                  <div className="bg-yellow-50 border-b border-white/10 p-1 flex gap-1 overflow-x-auto shrink-0 hide-scrollbar">
                    {holdOrders.map((held, idx) => (
                      <div key={idx} className="flex shrink-0 items-center bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl border border-yellow-400 px-2 py-1 text-xs">
                        <span className="font-bold text-white mr-2">{held.table}</span>
                ...
                <div className="bg-white/10 hover:bg-white/20 p-2 shrink-0">
                  <div className="flex justify-between items-end mb-2">
                    <div className="flex-1 border border-white/10 bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl p-2">
                      <div className="flex justify-between text-sm mb-1 text-slate-300"><span>Tiền hàng:</span> <span className="font-mono">{cart.reduce((sum, item) => sum + (item.price * item.qty), 0).toLocaleString()}</span></div>
                      <div className="flex justify-between text-sm mb-1 text-slate-300"><span>Chiết khấu:</span> <span className="font-mono">0</span></div>
                      <div className="flex justify-between font-bold text-lg text-white border-t border-white/10 pt-1 mt-1">
                  ...
                  <div className="grid grid-cols-5 gap-1">
                    <div className="col-span-3 grid grid-cols-4 gap-1">
                      {['7','8','9','*','4','5','6','000','1','2','3','DEL','C','0',',','+'].map((btn) => (
                        <button key={btn} onClick={() => handleKeypad(btn)} className="bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl border border-white/10 hover:bg-white/20 active:bg-slate-300 py-2 font-mono font-bold text-sm text-white rounded-sm">
                          {btn}
                        </button>
                      ))}
                    </div>
                    <div className="col-span-2 flex flex-col gap-1">
                      ...
                      <button onClick={() => posConfig.layout !== 'retail' && switchTable(null)} className="flex-1 bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl border border-white/10 hover:bg-white/20 font-bold text-sm text-white rounded-sm">
                        Quay lại
                      </button>
                    ...
                    {products.filter(item => (selectedCategory === 'all' || item.category === selectedCategory) && item.status !== 'not_ready').map((item) => (
                      ...
                      >
                        ...
                        <div className="relative z-10 flex flex-col h-full justify-between p-1">
                          <h3 className={`font-bold text-xs leading-tight line-clamp-2 ${item.image ? 'text-white drop-shadow-md' : 'text-white'}`}>{item.name}</h3>
          ...
          <div className="flex justify-center h-full animate-in fade-in relative w-full">
            ...
            <div className="w-full bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl md:rounded-3xl p-4 md:p-6 pb-24 shadow-md md:border border-white/10 relative overflow-y-auto max-w-lg mx-auto h-full md:h-auto">
              ...
              <div className="mt-6 mb-8 text-center">
                ...
                <p className="text-slate-400 text-sm">Nhân viên phục vụ (Part-time)</p>
              </div>

              <div className="bg-gradient-to-br from-gray-800 to-gray-800/50 rounded-lg p-5 border border-white/10 shadow-sm mb-6">
                <p className="text-slate-400 text-sm mb-1">Lương tích lũy tháng này</p>
                ...
                {[
                  ...
                  <div key={i} className={`p-4 rounded-md border ${log.status === 'active' ? 'bg-orange-500/10 border-orange-500/30' : 'bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl border-white/10'}`}>
                    ...
                    <div className="flex justify-between text-sm">
                      <span className="text-slate-400">In: {log.in} - Out: {log.out}</span>
        ...
        activeTab === 'hr' ? (
          <div className="flex flex-col items-center justify-center h-full animate-in zoom-in-95 duration-300 relative w-full">
            ...
            <p className="text-slate-400 mb-8">Hiển thị mã QR này cho nhân viên quét bằng App SmartStore để Check-in.</p>
          ...
          <div className="flex flex-col items-center justify-center h-full text-slate-400">
            ...
            <h2 className="text-2xl font-bold text-slate-400">Chưa được kích hoạt</h2>
          ...
          <div className="bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl rounded-xl shadow-2xl w-[400px] overflow-hidden animate-in zoom-in-95">
            <div className="p-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h3 className="text-xl font-bold text-white">Xác nhận</h3>
              </div>
              ...
              <div className="flex justify-end gap-3">
                <button 
                  ...
                  className="px-4 py-2 rounded-lg font-bold text-slate-300 hover:bg-white/10 hover:bg-white/20 transition-colors"
                >
                  Hủy
                </button>
                <button 
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[100] backdrop-blur-sm">
          <div className="bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl rounded-xl shadow-2xl w-[800px] max-h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95">
            <div className="p-6 border-b border-white/10 flex justify-between items-center bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl">
              <h2 className="text-2xl font-bold text-white">{editingProduct ? 'Sửa Sản Phẩm' : 'Thêm Sản Phẩm Mới'}</h2>
              <button onClick={() => setShowProductModal(false)} className="text-slate-400 hover:text-red-500 text-xl font-bold">✕</button>
            </div>
                ...
                <div className="bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl p-6 rounded-lg border border-white/10 shadow-sm mb-6">
                  ...
                  <div className="grid grid-cols-3 gap-6">
                    <div className="col-span-1 flex flex-col items-center justify-center border-2 border-dashed border-white/10 rounded-lg p-4 bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl relative group cursor-pointer hover:bg-white/10 hover:bg-white/20 transition-colors">
                      ...
                      {productForm.image ? (
                        ...
                        <div className="text-center">
                          ...
                          <div className="text-xs text-slate-400 font-bold">Thêm ảnh (Tùy chọn)</div>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="col-span-2 space-y-4">
                      <div>
                        <label className="block text-sm font-bold text-slate-200 mb-1">Tên Sản Phẩm <span className="text-red-500">*</span></label>
                        <input type="text" value={productForm.name} onChange={e => setProductForm({...productForm, name: e.target.value})} placeholder="VD: Trà Đào Cam Sả" className="w-full bg-white/5 border border-white/10 rounded-lg p-3 text-white" />
                      </div>
                      
                      <div className="flex gap-4">
                        <div className="flex-1">
                          <label className="block text-sm font-bold text-slate-200 mb-1">Giá bán (VNĐ) {editingProduct && <span className="text-red-500">*</span>}</label>
                          <input type="number" value={productForm.price} onChange={e => setProductForm({...productForm, price: e.target.value})} disabled={!editingProduct} placeholder={!editingProduct ? 'Chỉnh sửa sau khi tạo' : 'VD: 35000'} className={`w-full border rounded-lg p-3 font-bold ${!editingProduct ? 'bg-white/20 text-slate-400 cursor-not-allowed border-white/10' : 'bg-white/5 border-white/10 text-white'}`} />
                          {editingProduct && <p className="text-xs text-slate-400 mt-1">Giá vốn: <span className="font-bold text-blue-400">{productForm.recipe.reduce((total, req) => { const ing = ingredients.find(i => i.id === req.ingredientId); return total + (ing ? ing.cost * req.qty : 0); }, 0).toLocaleString()} đ</span></p>}
                        </div>
                        <div className="flex-1">
                          <label className="block text-sm font-bold text-slate-200 mb-1">Trạng thái</label>
                          <select value={productForm.status} onChange={e => setProductForm({...productForm, status: e.target.value})} disabled={!editingProduct} className={`w-full border rounded-lg p-3 font-bold ${!editingProduct ? 'bg-white/20 text-slate-400 cursor-not-allowed border-white/10' : 'bg-white/5 border-white/10 text-white'}`}>
                ...
                <div className="bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl p-6 rounded-lg border border-white/10 shadow-sm">
                  ...
                  {productForm.recipe.length === 0 ? (
                    <div className="text-center py-6 bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl border border-dashed border-white/10 rounded-lg">
                      <p className="text-slate-400 text-sm">Món này chưa thiết lập công thức.</p>
            ...
            <div className="p-6 border-t border-white/10 bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl flex justify-end gap-3">
              <button onClick={() => setShowProductModal(false)} className="px-6 py-2 rounded-lg font-bold text-slate-300 hover:bg-white/10 hover:bg-white/20">Hủy</button>
              <button 
                ...
                className={`px-6 py-2 rounded-lg font-bold shadow-sm ${!productForm.category ? 'bg-slate-300 text-slate-400 cursor-not-allowed' : 'bg-blue-600/70 backdrop-blur-md border border-blue-400/30 shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_25px_rgba(37,99,235,0.5)] hover:bg-blue-700/70 backdrop-blur-md text-white'}`}
              >
        ...
        <div className="absolute inset-0 bg-black/60 flex items-center justify-center z-50 backdrop-blur-sm">
          <div className="bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl border border-white/10 rounded-lg p-6 w-[500px] shadow-md border border-white/10 animate-in zoom-in-95">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div>
                <label className="block text-slate-400 mb-2">Ghi chú nhanh</label>
                  ...
                  {predefinedNotes.map((note, idx) => {
                    ...
                    return (
                      <button 
                        ...
                        className={`px-3 py-1.5 rounded-full text-sm font-bold transition-colors ${isSelected ? 'bg-blue-600/70 backdrop-blur-md border border-blue-400/30 shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_25px_rgba(37,99,235,0.5)] text-white' : 'bg-white/10 hover:bg-white/20 text-slate-300 hover:bg-white/20'}`}
                      >
                        {note}
                      </button>
                    )
                ...
                <textarea 
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-lg p-3 text-white placeholder-gray-500 focus:outline-none focus:border-blue-500"
                  rows="2"
                ></textarea>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <button onClick={() => { handleAddItem({...selectedItemForTopping, size: selectedSize, note: noteText.trim(), toppings: selectedToppings}); setSelectedItemForTopping(null); }} className="flex-1 bg-blue-600/70 backdrop-blur-md border border-blue-400/30 shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_25px_rgba(37,99,235,0.5)] hover:bg-blue-700/70 backdrop-blur-md text-white py-3 rounded-md font-bold transition-colors shadow-sm shadow-blue-500/30">Thêm vào giỏ</button>
            </div>
          </div>
        </div>
      )}
      ...
      {showPaymentModal && (
        <div className="absolute inset-0 bg-black/60 flex items-center justify-center z-50 backdrop-blur-sm">
          <div className="bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl border border-white/10 rounded-lg p-6 w-[500px] shadow-md border border-white/10">
            ...
            <div className="mb-6">
              <label className="block text-slate-400 mb-2 font-bold">Khách đưa (Nhập tay):</label>
            ...
            <label className="block text-slate-400 mb-3">Hoặc chọn nhanh:</label>
            ...
            <div className="flex gap-4">
              ...
              <button 
                ...
                className="flex-1 bg-blue-600/70 backdrop-blur-md border border-blue-400/30 shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_25px_rgba(37,99,235,0.5)] hover:bg-blue-700/70 backdrop-blur-md disabled:bg-white/20 disabled:text-slate-400 text-white py-4 rounded-md font-bold transition-colors shadow-sm shadow-blue-500/30 text-lg">
                Hoàn tất & In Bill
              </button>
            </div>
          </div>
          ...
          <div className="bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl rounded-2xl p-6 max-w-sm w-full shadow-2xl animate-[fadeIn_0.2s_ease-out]">
            ...
            <div className="flex gap-3">
              <button 
                ...
                className="flex-1 px-4 py-2.5 rounded-xl font-bold text-slate-300 bg-white/10 hover:bg-white/20 hover:bg-white/20 transition-colors">
                Hủy
              </button>
              <button 
                onClick={() => {
                ...
                className="flex-1 px-4 py-2.5 rounded-xl font-bold text-white bg-blue-600/70 backdrop-blur-md border border-blue-400/30 shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_25px_rgba(37,99,235,0.5)] hover:bg-blue-700/70 backdrop-blur-md transition-colors shadow-sm shadow-blue-500/30">
                Đồng ý
              </button>
            </div>
          </div>
        ...
        {Object.entries(tabNames).filter(([key]) => visibleTabs.includes(key)).slice(0, 5).map(([key, name]) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center justify-center w-full py-2 rounded-xl transition-all ${isActive ? 'text-blue-400' : 'text-slate-400 hover:text-slate-300'}`}
            >
